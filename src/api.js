...
export const getCarrito          = (clienteId) =>
  api.get(`/carrito/cliente/${clienteId}`);
export const agregarItemCarrito  = (clienteId, data) =>
  api.post(`/carrito/cliente/${clienteId}/items`, data);
export const actualizarItemCarrito = (clienteId, itemId, cantidad) =>
  api.patch(`/carrito/cliente/${clienteId}/items/${itemId}`, { cantidad });
export const eliminarItemCarrito = (clienteId, itemId) =>
  api.delete(`/carrito/cliente/${clienteId}/items/${itemId}`);
export const vaciarCarrito       = (clienteId) =>
  api.delete(`/carrito/cliente/${clienteId}/vaciar`);
