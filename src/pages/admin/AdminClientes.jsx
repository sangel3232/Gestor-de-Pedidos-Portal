...
const s = {
  ...
  form: { background: "#fff", borderRadius: 10, padding: "20px 24px", marginBottom: 24, display: "flex", flexDirection: "column", gap: 12, border: "1px solid #e5e7eb" },
  formTitle: { margin: 0, color: "#6b7280", fontSize: 15 },
  row: { display: "flex", gap: 12, flexWrap: "wrap" },
  input: { flex: "1 1 160px", padding: "10px 14px", borderRadius: 8, border: "1px solid #d1d5db", background: "#f8fafc", color: "#111827", fontSize: 14, outline: "none" },
  btn: { padding: "10px 22px", background: "#dc2626", color: "#fff", border: "none", borderRadius: 8, fontWeight: "bold", cursor: "pointer" },
  table: { background: "#fff", borderRadius: 10, overflow: "hidden", border: "1px solid #e5e7eb" },
  thead: { display: "grid", gridTemplateColumns: "60px 1fr 1fr 1fr 100px", padding: "10px 16px", background: "#f8fafc", color: "#6b7280", fontSize: 13, fontWeight: "bold" },
  trow: { display: "grid", gridTemplateColumns: "60px 1fr 1fr 1fr 100px", padding: "10px 16px", borderTop: "1px solid #e5e7eb", fontSize: 14 },
