...
const s = {
  ...
  form: { background: "#1e293b", borderRadius: 10, padding: "20px 24px", marginBottom: 24, display: "flex", flexDirection: "column", gap: 12 },
  ...
  thead: { display: "grid", gridTemplateColumns: "60px 1fr 1fr 1fr 100px", padding: "10px 16px", background: "#0f172a", color: "#64748b", fontSize: 13, fontWeight: "bold" },
