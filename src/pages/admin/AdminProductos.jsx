...
const s = {
  ...
  input: {
    ...
    border: "1px solid #d1d5db", background: "#f8fafc", color: "#111827", fontSize: 14, outline: "none",
  },
  btnPrimary: {
  ...
  trow: {
    display: "grid", gridTemplateColumns: "60px 1fr 1fr 110px 90px 160px",
    padding: "10px 16px", borderTop: "1px solid #e5e7eb", fontSize: 14, alignItems: "center",
  },
  btnEdit: {
    padding: "5px 12px", background: "#fef2f2", color: "#b91c1c",
    border: "1px solid #fca5a5", borderRadius: 6, cursor: "pointer", fontSize: 12, fontWeight: "bold",
  },
  btnDel: {
