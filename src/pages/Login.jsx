...
const s = {
  ...
  tabActive: { background: "#1e293b", color: "#38bdf8", fontWeight: "bold" },
  ...
  hintTitle: { margin: 0, fontSize: 11, color: "#64748b", textTransform: "uppercase", letterSpacing: 1 },
  hintRow: { display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "#94a3b8" },
  badge: {
