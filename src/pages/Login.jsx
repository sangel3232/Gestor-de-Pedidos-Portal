...
const s = {
  ...
  title: { color: "#b91c1c", margin: 0, textAlign: "center", fontSize: 20 },
  tabs: { display: "flex", background: "#f3f4f6", borderRadius: 8, padding: 4, gap: 4 },
  tab: {
    flex: 1, padding: "8px", border: "none", borderRadius: 6,
    background: "transparent", color: "#6b7280", cursor: "pointer", fontSize: 14,
  },
  tabActive: { background: "#fee2e2", color: "#b91c1c", fontWeight: "bold" },
  form: { display: "flex", flexDirection: "column", gap: 12 },
  input: {
    padding: "10px 14px", borderRadius: 8, border: "1px solid #d1d5db",
    background: "#f8fafc", color: "#111827", fontSize: 14, outline: "none",
  },
  btn: {
    padding: "12px", background: "#b91c1c", color: "#fff",
    border: "none", borderRadius: 8, fontWeight: "bold",
    fontSize: 15, cursor: "pointer", marginTop: 4,
  },
  error: { color: "#b91c1c", fontSize: 13, margin: 0, textAlign: "center" },
  hints: {
    background: "#f8fafc", borderRadius: 8, padding: "12px 14px",
    display: "flex", flexDirection: "column", gap: 6,
  },
  hintTitle: { margin: 0, fontSize: 11, color: "#6b7280", textTransform: "uppercase", letterSpacing: 1 },
  hintRow: { display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "#4b5563" },
  badge: {
