...
export default function Tienda() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const pedidoRes = await crearPedido({ descripcion, total: carrito.total, clienteId });
...
const s = {
  ...
  toast: {
    padding: "12px 18px", borderRadius: 8, border: "1px solid",
  ...
  productoCard: {
    ...
    border: "1px solid #1e293b", cursor: "default",
  },
  ...
  carritoPanel: {
    width: 340, minWidth: 300, background: "#1e293b", borderRadius: 12,
  ...
  checkoutBtn: {
    width: "100%", padding: "11px", background: "#4ade80", color: "#0f172a",
  ...
  pagoLabel: { fontSize: 13, color: "#94a3b8", margin: "12px 0 6px" },
  select: {
